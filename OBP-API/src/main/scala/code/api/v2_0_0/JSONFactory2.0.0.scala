...
import code.api.v1_4_0.JSONFactory1_4_0.TransactionRequestAccountFromJSON
...
case class TransactionRequestWithChargeJSONWrapper(
                                   id: String,
                                   `type`: String,
...
case class TransactionRequestWithChargeJSONsWrapper(
                                    transaction_requests_with_charges : List[TransactionRequestWithChargeJSONWrapper]
                                 )
...
case class TransactionRequestBodyFromJSON (
                                        to: TransactionRequestAccountFromJSON,
...
def createTransactionTypeJSON(transactionType : TransactionType) : TransactionTypeJSON = {
  ...
  def createTransactionRequestWithChargeJSON(tr : TransactionRequest) : TransactionRequestWithChargeJSONWrapper = {
    new TransactionRequestWithChargeJSONWrapper(
      id = tr.id.value,
      `type` = tr.`type`,
      from = TransactionRequestAccountFromJSON (
  ...
  def createTransactionRequestJSONs(trs : List[TransactionRequest]) : TransactionRequestWithChargeJSONsWrapper = {
    TransactionRequestWithChargeJSONsWrapper(trs.map(createTransactionRequestWithChargeJSON))
  }
