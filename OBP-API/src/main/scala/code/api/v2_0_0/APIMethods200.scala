...
import code.api.v1_4_0.JSONFactory1_4_0.{ChallengeAnswerJSON, CustomerFaceImageJson, TransactionRequestAccountFromJSON, TransactionRequestAccountJSON}
import code.entitlement.Entitlement
import code.model.TransactionRequestType
...
trait APIMethods200 {
  ...
  resourceDocs += ResourceDoc(
    ...
    resourceDocs += ResourceDoc(
      ...
      Extraction.decompose(ChallengeAnswerJSON("1233")),
      emptyObjectJson,
      emptyObjectJson :: Nil,
      true,
      true,
        ...
        user =>
          if (Props.getBool("transactionRequests_enabled", false)) {
            for {
              ...
              answerOk <- Connector.connector.vend.answerTransactionRequestChallenge(transReqId, answerJson.token)
